...
public class Assignment : MonoBehaviour
{
    ...
    public void As06_Calculate()
    {
        switch(as06Op)
        {
            ...
            case '/':
                ...
                break;
            default:
                Debug.Log("Invalid operator Use '+', '-', '*', '/'");
                return;
        }
    ...
    public void As08_PurchasingSystemExample()
    {
        if (as08Quantity > 0)
        {
            if(as08Quantity >= as08Price)
            {
                Debug.Log("You have received the product.");
                    if (as08Payment >= as08Price)
                {
                    Debug.Log($"Your change is: {as08Payment - as08Price}");
                }
            }
            else
            {
    ...
    public void As09_RockPaperScissorsExample()
    {
        if(as09UserChoice >= 0 && as09ComputerChoice <= 2)
        {
            ...
            else if (as09ComputerChoice == 0 && as09ComputerChoice == 2 || as09UserChoice == 1 && as09ComputerChoice == 0 || as09ComputerChoice == 2 && as09UserChoice == 1)
            {
                Debug.Log("You Win");
            }
            else
        ...
        {
            Debug.Log("Invalid input. Please enter 0 for Rock, 1 for Paper, or 2 for Scissors.");
        }
    ...
    public void As10_CalculateWeaponDamage()
    {
        ...
        Debug.Log($"Input: {as10WeaponType}, {as10BaseDamage} Total Damage: " + totalDamage.ToString());
    ...
    public void As11_DeterminePlayerRank()
    {
        ...
        else
        {
           ...
           else if (as11Score >= 4000 && as11Score < 6000)
            {
                rank = "Bronze"; baseCoins = 50;
            }
            else if (as11Score < 4000)
            {
               rank = "Participant"; baseCoins = 25;
            }
            ...
            else if (as11CompletionTime > 30 && as11CompletionTime <= 60)
            {
                timeBonus = 10;
            }
            else
